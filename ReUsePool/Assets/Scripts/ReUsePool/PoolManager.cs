...
namespace ReUsePool
{
    ...
    public class PoolManager : SingletonObject<PoolManager>
    {
        ...
        /// <returns></returns>
        public T SpawnClass<T>(string poolName) where T : class, IReUse
        {
        ...
        /// 如果复用池中数量大于等于 最大容量，则调用 IReUse接口的 Release 方法
        /// </summary>
        public void UnSpawnObject(string poolName, UnityEngine.GameObject t)
        {
            poolObjectController.UnSpawn(poolName, t);
        }

        /// <summary>
        /// 设置类对象复用池容量
        /// </summary>
        public void SetSpawnObjectCapacity(string poolName, int capacity)
        {
